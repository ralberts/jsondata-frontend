/**
 * This file contains all necessary Angular controller definitions for 'frontend.json.dataVersion' module.
 *
          ...
          DataVersionModel
            ...
            .then(
              function onSuccess(result) {
                ...
                $state.go('json.dataVersion', {id: result.data.id});
              }
            )
          ;
        };
